...
<style>
  ...
  #ValuesDataTable td.parameter-value-col {
    text-align: center;
  }

  #ValuesDataTable .parameter-binary-value {
  ...
  #ValuesDataTable .parameter-binary-value.value-yes {
    color: #32612D;
  }

  #ValuesDataTable .parameter-binary-value.value-no {
    color: #CA3433;
  }

  #ValuesDataTable .parameter-plain-value {
    color: #333;
    font-weight: 400;
  }
</style>
